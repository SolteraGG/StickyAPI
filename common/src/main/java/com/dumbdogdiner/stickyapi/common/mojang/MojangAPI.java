 ...
 */
package com.dumbdogdiner.stickyapi.common.mojang;

import com.dumbdogdiner.stickyapi.common.util.StringUtil;
import com.dumbdogdiner.stickyapi.common.util.http.HttpClient;
import com.dumbdogdiner.stickyapi.common.util.http.HttpConnectionException;
import com.dumbdogdiner.stickyapi.common.util.http.HttpException;
import com.dumbdogdiner.stickyapi.common.util.http.HttpStatusException;
...
public class MojangAPI {
    ...
    private static final @NotNull HttpClient CLIENT = new HttpClient();
    ...
    private static @NotNull Response getResponse(String param) throws HttpException {
        Request ashconRequest = new Request.Builder().url(
                ...
                .build();
        try {
            Response resp = CLIENT.getHttpClient().newCall(ashconRequest).execute();
            if (resp.code() == 200)
                return resp;
    ...
    public static @NotNull Map<String, MojangStatus> getMojangAPIStatus() throws HttpException {
        ...
        for (@NotNull JsonElement obj : CLIENT.getResponseAsJson(MOJANG_STATUS_URL).getAsJsonArray()) {
    ...
    public static @NotNull UUID uuidAtTime(@NotNull String username, @NotNull Instant timestamp) throws HttpException {
        ...
        return StringUtil.hyphenateUUID(CLIENT.getResponseAsJson(url).getAsJsonObject().get("id").getAsString());
    }
}
