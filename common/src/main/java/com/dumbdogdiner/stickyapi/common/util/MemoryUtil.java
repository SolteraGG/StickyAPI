...
public final class MemoryUtil {
    ...
    private static int getFieldSize(Object object, Field field) {
        try {
            ...
            return getSizeOf(
                ReflectionUtil.getProtectedValue(object, field.getName())
            );
    ...
    private static int getSizeOfBuiltin(Object object) {
        ...
        if (object instanceof String) return (
            ((String) (object)).length() * 8
        ); else if (object instanceof Boolean) return 1; else if (
            object instanceof Byte
        ) return 8; else if (
            object instanceof Short || object instanceof Character
        ) return 16; else if (
            object instanceof Long || object instanceof Double
        ) return 64; else return 0; // how this could happen) // potential for stack overflow if a field is circular! (maybe, but I don't see
    }
}
