...
public final class ReflectionUtil {
    ...
    public static void setProtectedValue(
        Object o,
        String field,
        Object newValue
    ) {
        ...
        try {
            ...
            if (Modifier.isFinal(f.getModifiers())) {
                ...
                if (
                    ...
                    "Cannot set field as non-final. Is this assigned final?"
                );
            }
    ...
    public static Constructor<?> getProtectedConstructor(
        Class<?> clazz,
        Class<?>... params
    ) {
        Constructor<?> c;
        ...
        if (Modifier.isProtected(m)) c.setAccessible(true);
    ...
    public static Object invokeProtectedMethod(
        ...
        try {
            ...
            for (int i = 0; i < args.length; i++) {
                if (args[i] instanceof Integer) pTypes[i] =
                    int.class; else pTypes[i] = args[i].getClass();
            }
