...
import static com.dumbdogdiner.stickyapi.util.MathUtil.randomDouble;
import static com.dumbdogdiner.stickyapi.util.MathUtil.randomInt;
...
class NbtNumberTagTest {
    ...
    @BeforeEach
    public void setUp(){
        i = MathUtil.randomInt(-256,  4096);
        f = (float) MathUtil.randomDouble(-256, 8192);
    }
