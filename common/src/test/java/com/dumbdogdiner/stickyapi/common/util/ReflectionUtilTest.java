...
public class ReflectionUtilTest {
    ...
    public void testProtectedValuePrivate() {
        ...
        ReflectionUtil.setProtectedValue(
            instance,
            "privateString",
            "edited_value"
        );
    ...
    public void testProtectedValuePrivateFinal() {
        ...
        assertEquals(
            ReflectionUtil.getProtectedValue(instance, "privateFinalString"),
            "edited_value"
        );
    ...
    public void testProtectedValuePrivateStaticFinal() {
        ...
        assertEquals(
            ReflectionUtil.getProtectedValue(c, "privateStaticFinalString"),
            "edited_value"
        );
    ...
    public void testProtectedValueProtected() {
        ...
        assertEquals(
            ReflectionUtil.getProtectedValue(
                (Object) instance,
                "protectedString"
            ),
            "edited_value"
    ...
    public void testGetProtectedValueObjectNoSuchField() {
        ...
        Object o = ReflectionUtil.getProtectedValue(
            (Object) instance,
            "nonexistent_field"
        );
