...
public class ServerVersionTest {
    ...
    public void testGetServerTypeBukkit() {
        try (MockedStatic<ServerVersion> mocked = mockStatic(ServerVersion.class)) {
            ...
            assertTrue(ServerVersion.getServerType().equals(ServerVersion.ServerType.BUKKIT));
    ...
    public void testGetServerTypeSpigot() {
        try (MockedStatic<ServerVersion> mocked = mockStatic(ServerVersion.class)) {
            ...
            assertTrue(ServerVersion.getServerType().equals(ServerVersion.ServerType.SPIGOT));
    ...
    public void testGetServerTypePaper() {
        try (MockedStatic<ServerVersion> mocked = mockStatic(ServerVersion.class)) {
            ...
            assertTrue(ServerVersion.getServerType().equals(ServerVersion.ServerType.PAPER));
    ...
    public void testGetServerTypeWaterfall() {
        try (MockedStatic<ServerVersion> mocked = mockStatic(ServerVersion.class)) {
            ...
            assertTrue(ServerVersion.getServerType().equals(ServerVersion.ServerType.WATERFALL));
    ...
    public void testGetServerTypeBungee() {
        try (MockedStatic<ServerVersion> mocked = mockStatic(ServerVersion.class)) {
            ...
            assertTrue(ServerVersion.getServerType().equals(ServerVersion.ServerType.BUNGEE));
