...
public class PacketRegistration {
    ...
    private static void processReflection() {
        try {
            ...
            protocolMappingArray =
                Array.newInstance(protocolMapping, 0).getClass();
    ...
    public static void registerSoundPacket() {
        ...
        registerPacket(
            SoundPacket.class,
            com.dumbdogdiner.stickyapi.bungeecord.protocol.Protocol.getSoundEffectId()
        ); // This should automatically register with the server's correct version
    }
}
