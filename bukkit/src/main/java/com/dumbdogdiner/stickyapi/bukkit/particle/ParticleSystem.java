...
public class ParticleSystem {
    ...
    public void setRoot(@NotNull Location root) {
        if (!root.getWorld().equals(world)) {
            throw new IllegalArgumentException(
                "New root must be contained within the system's original world."
            );
        }
        this.root = root;
    }
    ...
    private void ensureRelative() {
        if (!isAbsolute()) throw new RuntimeException(
            "Cannot use relative methods - system is absolute"
        );
    }
    ...
    private void ensureDefaultParticle() {
        if (this.particle == null) throw new RuntimeException(
            "Cannot use default particle - particle is null"
        );
    }
     ...
     * @return {@link ParticleSystem}
     */
    public ParticleSystem spawnAbsolute(
        @NotNull Particle particle,
        double x,
        double y,
        double z,
     ...
     * @return {@link ParticleSystem}
     */
    public ParticleSystem parametric(
        @NotNull Particle particle,
        @NotNull Parametric parametric,
        double t0,
        double t1,
        double stepSize,
        int count,
     ...
     * @return {@link ParticleSystem}
     */
    public ParticleSystem parametricAbsolute(
        @NotNull Particle particle,
        @NotNull Parametric parametric,
        double t0,
        double t1,
    ...
    public ParticleSystem parametricAbsolute(
        ...
        return this.parametricAbsolute(
                particle,
                parametric,
                t0,
                t1,
     ...
     * @return {@link ParticleSystem}
     */
    public ParticleSystem lineAbsolute(
        @NotNull Particle particle,
        double x1,
        double y1,
        double z1,
     ...
     * @return {@link ParticleSystem}
     */
    public ParticleSystem shapeAbsolute(
        @NotNull Particle particle,
        @NotNull Shape shape,
        @Nullable Particle.DustOptions data
    ) {
