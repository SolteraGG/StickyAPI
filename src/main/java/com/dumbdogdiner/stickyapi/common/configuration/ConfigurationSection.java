...
public interface ConfigurationSection {
     ...
     * <p>
     * If deep is set to false, then this will contain only the keys of any direct
     ...
     * any child {@link ConfigurationSection}s (and their children, etc). These keys
     * will be in a valid path notation for you to use.
     * <p>
     * If deep is set to false, then this will contain only the keys and values of
     * any direct children, and not their own children.
     *
     * @param deep Whether or not to get a deep list, as opposed to a shallow list.
     ...
     * @return True if this section contains the requested path, either via default
     *         or being set.
     ...
     * <p>
     * To retrieve the single name of this section, that is, the final part of the
     * path returned by this method, you may use {@link #getName()}.
     *
    ...
    /**
     * Creates a {@link ConfigurationSection} at the specified path, with specified
     * values.
     * <p>
     * Any value that was previously set at this path will be overwritten. If the
     * previous value was itself a {@link ConfigurationSection}, it will be
     ...
     * default value has been specified, this will check if that default value is a
     * String and return appropriately.
     *
     ...
     * return the default value. If the int does not exist and no default value was
     * specified, this will return 0.
     *
     ...
     * <p>
     * If the path exists but is not a int, this will return false. If the path does
     * not exist, this will return false. If the path does not exist but a default
     * value has been specified, this will check if that default value is a int and
     ...
     * <p>
     * If the path exists but is not a boolean, this will return false. If the path
     * does not exist, this will return false. If the path does not exist but a
     * default value has been specified, this will check if that default value is a
     * boolean and return appropriately.
     *
     ...
     * does not exist, this will return false. If the path does not exist but a
     * default value has been specified, this will check if that default value is a
     * double and return appropriately.
     *
     ...
     * <p>
     * If the long does not exist but a default value has been specified, this will
     * return the default value. If the long does not exist and no default value was
     * specified, this will return 0.
     *
     ...
     * <p>
     * If the List does not exist but a default value has been specified, this will
     * return the default value. If the List does not exist and no default value was
     ...
     * If the List does not exist but a default value has been specified, this will
     * return the default value. If the List does not exist and no default value was
     * specified, this will return an empty List.
     * <p>
     ...
     * specified, this will return an empty List.
     * <p>
     * This method will attempt to cast any values into a Character if possible, but
     * may miss any values out if they are not compatible.
     *
     * @param path Path of the List to get.
     ...
     * {@link #getString(String) #getString(path)} converts internally all Objects
    ...
    /**
     * Gets the requested object at the given path, returning a default value if not
     * found
     *
     * If the Object does not exist then the specified default value will returned
     * regardless of if a default has been identified in the root
     * {@link Configuration}.
     *
     * <b>Note:</b> For example #getObject(path, String.class, def) is <b>not</b>
     * equivalent to {@link #getString(String, String) #getString(path, def)}
     * because {@link #getString(String, String) #getString(path, def)} converts
     * internally all Objects to Strings. However, #getObject(path, Boolean.class,
     ...
     * If the path does not exist, this will return false. If the path does not
     * exist but a default value has been specified, this will check if that default
     * value is a ConfigurationSection and return appropriately.
     *
     ...
     * this path, or the value at this path is not a {@link ConfigurationSection}
     ...
     * source.
     * <p>
     * If the value as returned by {@link #getDefaultSection()} is null, then this
