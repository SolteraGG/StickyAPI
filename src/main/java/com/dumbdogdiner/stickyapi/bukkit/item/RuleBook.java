...
import com.dumbdogdiner.stickyapi.common.util.commonmarkextensions.MCColorFormatExtension;
...
public class RuleBook {
    ...
    public static void generateDefault() throws IOException {
        Parser cmparser = Parser.builder()
                .extensions(Collections.singletonList(MCColorFormatExtension.create()))
                .build();
