...
public class BookGenerator {
    ...
    public BookGenerator(Material material){
        ...
        meta = (BookMeta) new ItemStack(material).getItemMeta();
    }
    /*
 ...
 */
  ...
  */
    ...
    public  BookGenerator setGeneration(BookMeta.Generation generation){
    ...
    public BookGenerator setTitle(String title){
        this.title = title;
        return this;
    }
