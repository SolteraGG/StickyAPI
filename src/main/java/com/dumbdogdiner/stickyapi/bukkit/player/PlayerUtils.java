...
public class PlayerUtils {
    ...
    public static class OfflinePlayerSeenComparator implements Comparator<OfflinePlayer> {
        ...
        /**
         * Bigger number means seen more recently, which means we want it earlier in the
         * list, so return -1 if o1 has a bigger number, we should return a negative
         * number if o2 has a bigger number, we should return a positive number Check
         * the following, in order, break on non-tie: lastSeen, lastLogin, firstLogin,
         * compare names as strings if still a tie just return 0
         * 
         * @param o1 The first {@link org.bukkit.OfflinePlayer}
         * @param o2 The second {@link org.bukkit.OfflinePlayer}
         * @return An integer representing if o1 is less than, equal to, or greater than
         *         o2
         */
        @Override
        public int compare(OfflinePlayer o1, OfflinePlayer o2) {

            long[] diffs = new long[] { o2.getLastSeen() - o1.getLastSeen(), o2.getLastLogin() - o1.getLastLogin(),
